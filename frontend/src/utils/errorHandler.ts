...
export const ERROR_CODE_TO_MESSAGE = {
  ...
  [ERROR_KEYS.ONLY_ONE_APPLICATION_PER_24H]:
    "You have applied too many times. Would you like to restore your deleted application?",
  [ERROR_KEYS.COMPANY_IS_FROZEN]:
    "Your account has been frozen and you cannot make new offers. Contact support for more information",
};
