...
export const useContactBorrower = (id: string) => {
  ...
  return useQuery({
    ...
    queryFn: () => axios.get<ReturnType<typeof contactBorrower>>(`/loan-response/${id}/contact-borrower`).then((res) => res.data)
  });
};
...
export const useGetLoanResponseByIds = (loanResponseIds: string[]) => {
  ...
  return useQuery({
    ...
    queryFn: () =>
      axios.get<ReturnType<typeof getLoanResponseByIds>>(`/loan-response/ids`, { params: { loanResponseIds } }).then((res) => res.data)
  });
};
